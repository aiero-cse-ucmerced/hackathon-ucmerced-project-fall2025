...
const PreferencesPage = () => {
  ...
  const [studyRemindersEmail, setStudyRemindersEmail] = useState(true);
  const [practiceNotificationsEmail, setPracticeNotificationsEmail] = useState(false);
  const [dailyStudyRemindersEmail, setDailyStudyRemindersEmail] = useState(true);
  const [streakReminderEmail, setStreakReminderEmail] = useState(true);
  const [levelProgressEmail, setLevelProgressEmail] = useState(false);
  const [inactivityReminderEmail, setInactivityReminderEmail] = useState(true);
  const [storePromotionsEmail, setStorePromotionsEmail] = useState(false);
  const [classUpdatesEmail, setClassUpdatesEmail] = useState(true);
  const [newFollowerEmail, setNewFollowerEmail] = useState(true);
  const [friendActivityEmail, setFriendActivityEmail] = useState(false);
  const [referralUpdatesEmail, setReferralUpdatesEmail] = useState(true);
  const [marketingEmail, setMarketingEmail] = useState(false);

  const [studyRemindersMobile, setStudyRemindersMobile] = useState(true);
  const [practiceNotificationsMobile, setPracticeNotificationsMobile] = useState(false);
  const [dailyStudyRemindersMobile, setDailyStudyRemindersMobile] = useState(true);
  const [streakReminderMobile, setStreakReminderMobile] = useState(true);
  const [levelProgressMobile, setLevelProgressMobile] = useState(false);
  const [inactivityReminderMobile, setInactivityReminderMobile] = useState(true);
  const [storePromotionsMobile, setStorePromotionsMobile] = useState(false);
  const [classUpdatesMobile, setClassUpdatesMobile] = useState(true);
  const [newFollowerMobile, setNewFollowerMobile] = useState(true);
  const [friendActivityMobile, setFriendActivityMobile] = useState(false);
  const [referralUpdatesMobile, setReferralUpdatesMobile] = useState(true);
    ...
    <div className="min-h-screen bg-white text-gray-900">
      <div className="p-4">
        ...
        <div className="flex space-x-2 mt-4 overflow-x-auto scrollbar-hide">
          <button className="flex items-center px-4 py-2 rounded-full bg-blue-900 text-white text-sm">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
            </svg>
            Account
          </button>
          <button className="flex items-center px-4 py-2 rounded-full bg-gray-200 text-gray-700 text-sm">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="p-4 mt-4">
        ...
        <div className="flex items-center mb-4">
          ...
          <div>
            <p className="text-lg font-medium">Dominexus Prime</p>
            <p className="text-gray-600 text-sm">draxonziz</p>
          </div>
        ...
        <div className="flex justify-between items-center py-2 border-b border-gray-200">
          ...
          <div className="flex items-center">
            <p className="text-gray-600 mr-4">draxonziz</p>
        ...
        <div className="flex justify-between items-center py-2 border-b border-gray-200">
          <p>Email</p>
          <div className="flex items-center">
            <p className="text-gray-600 mr-4">thelegendspk101@gmail.com</p>
            <button className="text-blue-600 text-sm">Change</button>
          </div>
        </div>
